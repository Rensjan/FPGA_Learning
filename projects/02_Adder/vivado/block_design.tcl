...
\
  ...
  set block_name AXI_Adder
  set block_cell_name AXI_Adder_0
  if { [catch {set AXI_Adder_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $AXI_Adder_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins AXI_Adder_0/s00_axi]
  ...
  [get_bd_pins AXI_Adder_0/s00_axi_aclk] \
  ...
  [get_bd_pins AXI_Adder_0/s00_axi_aresetn] \
  [get_bd_pins axi_smc/aresetn]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_Adder_0/s00_axi/reg0] -force
